...
for h = 1:length(hemi);
    for t = 1:size(time,1);
        ...
        %% GROUP TOPOPLOTS - AT PRECISE LATENCIES 40 60 100 200
            ...
            cd(SaveDir)
            saveas(gcf, 'Group_Topoplot_Precise_Latencies_BL_leftpfc.png');
            saveas(gcf, 'Group_Topoplot_Precise_Latencies_BL_leftpfc.fig');
        ...
        cd(SaveDir);
        saveas(gcf, 'Group_Topoplot_Within_Time_Ranges_BL_leftpfc.png');
        saveas(gcf, 'Group_Topoplot_Within_Time_Ranges_BL_leftpfc.fig');
...
figure;
    ...
    saveas(gcf, 'Grand_Average_ButterflyPlotTEP_F1_BL_leftpfc.png');
    saveas(gcf, 'Grand_Average_ButterflyPlotTEP_F1_BL_leftpfc.fig');
